...
快速记账功能可以帮你一键复制历史记账记录到今天，省去重复输入的麻烦。

### 入口

| 入口 | 说明 |
|------|------|
| 侧边栏图标 | 点击 📋 图标，快速打开记账弹窗 |
| 记账视图按钮 | 点击"快速复制"按钮 |
| 命令面板 | `Ctrl/Cmd + P` → 搜索"快速记账" |

### 使用方法

1. 点击侧边栏的 📋 图标或记账视图中的"快速复制"按钮
2. 在弹窗中会显示最近 14 天的记账记录（去重）
3. 可以通过搜索框或分类筛选快速找到记录
4. 点击"复制"直接写入今天的日记，或点击"编辑"修改金额后再写入
5. 复制完成后自动跳转到今天的日记笔记

<!-- 在此处添加快速记账弹窗截图 -->
<!-- ![快速记账弹窗](./assets/obsidian-accounting-quick-copy.png) -->
